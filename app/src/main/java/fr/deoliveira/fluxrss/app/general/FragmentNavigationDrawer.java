...
public class FragmentNavigationDrawer extends DrawerLayout {
    ...
    public void setupDrawerConfiguration(ListView drawerListView, Toolbar drawerToolbar, int drawerItemRes, int drawerContainerRes,View rootDrawerView) {
        /**
    ...
    public boolean isDrawerOpen() {
        return isDrawerOpen(rootDrawerView);
    }
}